...
const OliSVG = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 220" width="120" height="120">
...
export default function OliWidget() {
  ...
  return (
    <div className="flex items-center justify-center w-full h-full pb-0 mb-0">
      {show && (
        <motion.div
